  ...
  return (
    <div className="flex flex-col md:flex-row flex-wrap bg-sky-400 rounded-lg px-6 md:px-10 lg:px-20">
      ...
      <div
        ...
        data-aos="fade-right"
      >
        <p className="text-3xl md:text-4xl lg:text-5xl sm:text-center text-white font-semibold leading-tight md:leading-tight lg:leading-tight">
        ...
        <a
          href="#speciality"
          className="flex items-center gap-2 bg-sky-100 px-8 py-4 rounded-full text-gray-600 text-sm md:m-0 hover:scale-105 transition-all duration-300 "
        >
